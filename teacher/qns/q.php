      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" class="toactive">
          <ul class="nav navbar-nav" class="list-inline">
            <li class="cli"><a href=>Home</a></li>

            <li class="cli"><a href=>Back</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
    ...
    <div class="col-md-offset-2 col-md-8">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="wrong_answer1" name="wrong_answer1" placeholder="Wrong answer 1" Required><br>
				<input type="button" value="+add more options" name="adqn">
            </div>
