...
<div class="row">
<div class="col-lg-6">
<span class="logo">Question Panel</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>Add questions</b></a>
    </div>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=4">Add Training</a></li>
            <li><a href="dash.php?q=5&id2=<?php echo $id ?>">Remove Training</a></li>
